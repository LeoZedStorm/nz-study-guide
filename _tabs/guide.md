...
- 💰 [学费与总花费]({{ site.baseurl }}/guide/costs/) —— 学费查询渠道、参照学费量级、保险与签证等杂费
- 🛂 [签证与毕业工签]({{ site.baseurl }}/guide/visa/) —— 学生签证、Post-Study Work Visa 申请流程
- 🧳 [行前准备清单]({{ site.baseurl }}/guide/predeparture/) —— 证件材料、**驾照翻译公证**、生物安全申报、药品携带、行李/气候与时差

**落地安家**
- 🛬 [落地第一周]({{ site.baseurl }}/guide/arrival/) —— 机场进城、交通卡、开户、办卡、校园报到
...
还有一些项目本身的常见疑问（转段模式、双学位认证等），整理在 [FAQ]({{ site.baseurl }}/faq/) 页面。

> ⚠️ 以下内容基于奥克兰大学官网等公开信息整理，仅作一般性参考，不构成官方签证/移民/财务建议。四川大学奥克兰学院是 2026 年才获批的新项目，涉及联合项目学生的专属安排（选课方式、签证细则、转段模式等），公开渠道暂无官方说明的地方本站会明确标注，请以学院官方通知为准。
